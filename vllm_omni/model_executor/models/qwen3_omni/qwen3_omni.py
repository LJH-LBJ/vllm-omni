...
class Qwen3OmniMoeForConditionalGeneration(
    ...
    def talker_preprocess_prefill(self, input_ids: torch.Tensor, input_embeds: torch.Tensor, payload: OmniPayload):
        ...
        num_processed_thinker_tokens = payload.get("num_processed_thinker_tokens", 0)
        ...
        decode_assistant_fill = payload.get("thinker_decode_embeddings")
        ...
        if decode_assistant_fill is None:
            cached_dec = payload.get("cached_thinker_decode_embeddings")
